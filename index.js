...
*/
console.log('task 1b:', createMenuItem('Grilled Cheese', 5, 'Lunch'));
console.log('task 1b:', createMenuItem('Fried Chicken', 10, 'Dinner'));
console.log('task 1b:', createMenuItem('Peanut Butter and Jelly', 6, 'Kids Menu'));
...
function addReview(oldReviews, name, rating, feedback){
  let reviews = [...oldReviews]
  const newReview = {
    name: name,
    rating: rating,
    feedback: feedback,
